...
import { PRIMARY_WA_LINK } from "@/lib/constants";
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6 md:p-8 space-y-2 sm:space-y-3">
                ...
                <a href={PRIMARY_WA_LINK} target="_blank" rel="noopener noreferrer" className="inline-block text-primary text-xs sm:text-sm tracking-[0.15em] uppercase font-display font-semibold hover:text-gold-light transition-colors pt-1 sm:pt-2 story-link">
